...
#  strange model: a fully-connected ReLU network that on each forward pass chooses
#  a random number between 1 and 4 and uses that many hidden layers, reusing the
#  same weights multiple times to compute the innermost hidden layers.
# 
