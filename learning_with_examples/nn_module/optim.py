...
#  mutating the Tensors holding learnable parameters (with torch.no_grad() or
#  .data to avoid tracking history in autograd). This is not a huge burden
#  for simple optimization algorithms like stochastic gradient descent,
