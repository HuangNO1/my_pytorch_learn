...
# 
# When building neural networks we frequently think of arranging
#  the computation into layers, some of which have learnable
#  parameters which will be optimized during learning.
# 
# In TensorFlow, packages like Keras, TensorFlow-Slim, and TFLearn
#  provide higher-level abstractions over raw computational
